...
if($iphone || $ipad)
{
 echo "<script>window.location.href='http://www.facaii.cn'</script>";//这里也可以是网址
}
if($android){
 echo "<script>window.location.href='http://wap.facaii.cn'</script>";//这里也可以是网址
}
?>
...
<div class="main-inner"><div class="warp980">
    <div class="box_layer">
        ...
        <div class="login">
            ...
            <div class="forgotpasswd"> <a href="r/5D545A">免费注册</a></div>
...
<p class="t-right">未满18周岁禁止购买<br />Copyright © SinCai 2010-2020  天时娱乐 版权所有</p></div>
</div></div>
