...
<div style=" min-height:430px;" id="container">
	<table id="chartsTable" width="100%" cellpadding="0" cellspacing="0" border="0" style="display: table;">
       	       		...
       	       		<tbody>
		<tr id="title">
             <td style="width:25%;"><strong>期号</strong></td>
             <td colspan="5" class="redtext"><strong>开奖号码</strong></td>
             <td colspan="5" class="redtext"><strong>预测号码</strong></td>
    	</tr>
		...
		<?php
				...
				$fieldsStr="time, number, data,func_ext";
				
				$fieldsStr2="a.time, a.number, a.data, a.func_ext";
                ...
                if($oj->function1->result==1){
                    $yucedata2 = $oj->function1->data;
                }else if($oj->function2->result==1){
                    $yucedata2 = $oj->function2->data;
                }else if($oj->function3->result==1){
                    $yucedata2 = $oj->function3->data;
                }else{
                    $yucedata2 = '等';
                }
                ...
                echo '<td class="wdh" align="center"><div class="ball05">'.$yucedata2.'</div></td>';
                echo '<td class="wdh" align="center"><div class="ball05">'.$yucedata2.'</div></td>';
                echo '<td class="wdh" align="center"><div class="ball05">'.$yucedata2.'</div></td>';
                echo '<td class="wdh" align="center"><div class="ball05">'.$yucedata2.'</div></td>';
                echo '<td class="wdh" align="center"><div class="ball05">'.$yucedata2.'</div></td>';
                ...
                if($oj->function1->result==1){
                    $yucedata = $oj->function1->data;
                }else if($oj->function2->result==1){
                    $yucedata = $oj->function2->data;
                }else if($oj->function3->result==1){
                    $yucedata = $oj->function3->data;
                }else{
                    $yucedata = '等';
                }
...
<script type="text/javascript" src="/js/nsc_m/res_bak.js?v=1.17.2.1"></script>
<script type="text/javascript">
$(function(){
    var riable=0;
